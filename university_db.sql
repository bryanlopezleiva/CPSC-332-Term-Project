...
('667788990', '09', 'CPSC-332', 'C'),
('667788990', '01', 'CPSC-440', 'B'),

('280011234', '05', 'CPSC-323', 'B'),
('280011234', '09', 'CPSC-332', 'B+'),
('280011234', '01', 'CPSC-440', 'A'),
('280011234', '08', 'MATH-338', 'C+');
...
-- STUDENTS QUERY
SELECT CS.CSNum AS Section_Number, CS.CLASSROOM, CS.Meeting_Days, CS.BEGIN_TIME, CS.END_TIME,
